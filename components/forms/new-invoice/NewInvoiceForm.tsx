...
export default function NewInvoiceFormLayout() {
  return (
    <div className="bg-white text-black max-w-3xl mx-auto p-10 rounded-md shadow-md space-y-10">
      {/* Company Header + Invoice Info */}
      <div className="flex justify-between border-b pb-6">
        <div className="space-y-1">
          <h1 className="text-2xl font-bold">Golden Spa</h1>
          <p>56 Zen Way</p>
          <p>Alpha, MN 56111</p>
          <p>admin@goldenspa.com</p>
          <p>https://www.goldenspa.com</p>
        </div>
        <div className="text-right space-y-1">
          <p className="text-lg font-semibold text-blue-800">INVOICE</p>
          <p className="text-sm">Invoice #: INV-2025-0001</p>
      ...
      <div className="flex justify-between border-b pb-6">
        <div className="w-1/2">
          ...
          <p>Shawn Harrington</p>
          <p>2085009450</p>
          <p>shawn.harrington2776@gmail.com</p>
        </div>
      ...
      {/* Line Items */}
      <div className="overflow-x-auto flex mb-0 pb-0">
        <table className="w-full text-sm border mb-6">
          <thead>
            <tr className="bg-blue-900 text-white">
              <th className="p-2 w-6"></th> {/* icon column */}
            ...
            <tr>
              ...
              <td className="p-2">
                <Select>
                  ...
                  <SelectContent>
                    <SelectItem value="1">Jimmy John&apos;s</SelectItem>
                  </SelectContent>
                </Select>
              </td>
      ...
      <div className="mt-0 pt-0 flex justify-between w-full">
